...
const { containerConfig, startConfig, runConfig, buildConfig } = require('../../configs/container/java.config.js');
...
class CPlusPlus extends Lang {
  ...
  async createContainer() {
    ...
    const containerName = `java_container_${this.id}`;
    try {
  ...
  async startContainer() {
    try {
      await this.vm.start();
      console.log('Start java container successfully!');
    }
    catch (e) {
      this.setExitCode(CodeError.SERVER_ERROR);
      throw e;
